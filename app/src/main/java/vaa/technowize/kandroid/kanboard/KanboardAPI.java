...
import vaa.technowize.kandroid.kanboard.events.OnCreateCommentListener;
import vaa.technowize.kandroid.kanboard.events.OnCreateSubtaskListener;
import vaa.technowize.kandroid.kanboard.events.OnCreateTaskListener;
import vaa.technowize.kandroid.kanboard.events.OnDownloadTaskFileListener;
import vaa.technowize.kandroid.kanboard.events.OnDuplicateTaskToProjectListener;
...
import vaa.technowize.kandroid.kanboard.events.OnGetAllCommentsListener;
import vaa.technowize.kandroid.kanboard.events.OnGetAllSubtasksListener;
import vaa.technowize.kandroid.kanboard.events.OnGetAllTaskFilesListener;
import vaa.technowize.kandroid.kanboard.events.OnGetAllTasksListener;
import vaa.technowize.kandroid.kanboard.events.OnGetCategoryListener;
import vaa.technowize.kandroid.kanboard.events.OnGetColumnsListener;
import vaa.technowize.kandroid.kanboard.events.OnGetDefaultColorListener;
...
import vaa.technowize.kandroid.kanboard.events.OnGetMyProjectsListListener;
...
import vaa.technowize.kandroid.kanboard.events.OnGetSwimlaneListener;
import vaa.technowize.kandroid.kanboard.events.OnGetTaskListener;
import vaa.technowize.kandroid.kanboard.events.OnGetVersionListener;
import vaa.technowize.kandroid.kanboard.events.OnMoveTaskPositionListener;
import vaa.technowize.kandroid.kanboard.events.OnMoveTaskToProjectListener;
import vaa.technowize.kandroid.kanboard.events.OnOpenTaskListener;
import vaa.technowize.kandroid.kanboard.events.OnRemoveCommentListener;
import vaa.technowize.kandroid.kanboard.events.OnRemoveSubtaskListener;
import vaa.technowize.kandroid.kanboard.events.OnRemoveTaskFileListener;
import vaa.technowize.kandroid.kanboard.events.OnRemoveTaskListener;
import vaa.technowize.kandroid.kanboard.events.OnSubtaskTimetrackingListener;
import vaa.technowize.kandroid.kanboard.events.OnUpdateCommentListener;
